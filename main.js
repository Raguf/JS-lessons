...
const [dolma, , kebab, ...otherFood] = [
  ...restaurant.mainMenu,
  ...restaurant.startMenu,
];
console.log(dolma, kebab, otherFood);
...
restaurant.orderPizza && restaurant.orderPizza('Pendir', 'Un');
*/
...
const game = {
  ...
  score: '4:0',
  scored: ['Levandovsky', 'Gnarby', 'Levandovsky', 'Hummels'],
  date: 'Nov 9th 2037',
  odds: {
    team1: 1.33,
    x: 3.25,
